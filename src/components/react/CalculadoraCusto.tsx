...
export default function CalculadoraCusto() {
  ...
  const naoNegativo = (set: (v: number) => void) => (valor: number) => set(Math.max(0, Number.isFinite(valor) ? valor : 0));
